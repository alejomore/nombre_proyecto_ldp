        ...
        <div class="row">
            ...
            <div class="col-9">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="titulo" id="titulo" class="form-control" value="{{$proyecto->titulo}}" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
                <div class="input-group">
                    <span class="input-group-text">Descripción</span>
                    <textarea name="descripcion" id="descripcion" class="form-control" aria-label="With textarea">
